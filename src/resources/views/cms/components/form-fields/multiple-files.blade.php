        ...
        <div class="row images-sortable">
            @foreach ($value as $file)
                @if (getType($file)=='string') 
                    <div class="col-auto single-multiple-image" data-image="{!! $file !!}">
                        {{-- <img class="img-thumbnail" src="{{ Storage::url($file) }}"> --}}
                         <a href="{{ Storage::url($file) }}" target="_blank"><i class="fa fa-file" aria-hidden="true"></i><span
                        class="btn-sm">view file</span></a>

                        <div class="bg-danger text-white delete-btn" data-image="{{ $file }}">
