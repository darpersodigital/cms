...
@endphp
<div class="form-input-container input-wrapper mt-3">
    ...
    @if (isset($value) && $value)
        <div class="img-container position-relative single-image pb-2">
            ...
            <div class="bg-danger text-white delete-btn remove-current-image" data-testid="remove-current-image-{{$locale ? $locale .'-' :""}}{{$testID ?? ""}}">
