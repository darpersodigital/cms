@php
    if (isset($post_type)) {
        ...
        $row_field_form_field_configs_1 = isset($field['form_field_configs_1']) ? $field['form_field_configs_1'] : null;
        $row_field_form_field_configs_2 = isset($field['form_field_configs_2']) ? $field['form_field_configs_2'] : null;
        $row_field_description = $field['description'] ?? '';
        $row_field_is_form = isset($field['is_form']) ? $field['is_form'] : 1;
        $row_field_has_sitemap = isset($field['has_sitemap']) ? $field['has_sitemap'] : 1;
...
<tr class="sortable-row position-relative field" type="{{ $field_type }}">
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}name">
    ...
    <td class="text-center" data-testid="select-container-{{ $field_type ? $field_type . '_' : '' }}migration_type">
        <select class="form-control w-100 default-select" name="{{ $field_type ? $field_type . '_' : '' }}migration_type[]">
            <option></option>
    ...
    <td class="text-center" data-testid="select-container-{{ $field_type ? $field_type . '_' : '' }}form_field">
        <select class="form-control w-100 default-select" name="{{ $field_type ? $field_type . '_' : '' }}form_field[]">
            <option></option>
            @foreach ($form_fields as $form_field)
                @if ($field_type == 'translatable')
                    @if (
                        $form_field != 'email' &&
                            $form_field != 'password' &&
                            $form_field != 'password with confirmation' &&
                            $form_field != 'select' &&
        ...
        <div class="form-field-configs" {!! ($row_field_form_field_configs_1 || $row_field_form_field_configs_2) ? '' : 'style="display: none;"' !!}>
            <input type="hidden" name="{{ $field_type ? $field_type . '_' : '' }}old_form_field_configs_1[]"
                value="{{ $row_field_old_form_field_configs_1 }}">
            <input class="form-control mt-2" name="{{ $field_type ? $field_type . '_' : '' }}form_field_configs_1[]"
                value="{{ $row_field_form_field_configs_1 }}">

            <input class="form-control mt-2" name="{{ $field_type ? $field_type . '_' : '' }}form_field_configs_2[]"
    ...
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}hide_table">
    ...
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}can_create">
        @include('darpersocms::cms.components.form-fields.checkbox-number', [
    ...
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}can_read">
        @include('darpersocms::cms.components.form-fields.checkbox-number', [
    ...
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}can_update">
        @include('darpersocms::cms.components.form-fields.checkbox-number', [
    ...
    <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}nullable">
        @include('darpersocms::cms.components.form-fields.checkbox-number', [
    ...
    @if (!$field_type)
        <td class="text-center" data-testid="{{ $field_type ? $field_type . '_' : '' }}unique">
            @include('darpersocms::cms.components.form-fields.checkbox-number', [
    ...
    @endif
    <td class="text-center"  >
        <button data-testid="{{ $field_type ? $field_type . '_' : '' }}removeField" class="btn-action  delete ml-2" type="button" onclick="removeField(this)"><i
